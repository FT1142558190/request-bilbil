...
class BSpider():
    ...
    def __init__(self):
        ...
        self.browser = webdriver.FirefoxOptions(options=options)
    ...
    def get_video_detial(self, video_detial_dect):
        ...
        try:
            ...
            video_detial_dect['date'] = self.browser.find_element(By.XPATH, '//*[@id="viewbox_report"]/div/span[3]').text
